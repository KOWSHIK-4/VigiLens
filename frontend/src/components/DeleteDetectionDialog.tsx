...
export function DeleteDetectionDialog({ open, onClose, detection }: DeleteDetectionDialogProps) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-labelledby="delete-detection-title" className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 drawer-enter">
        <div className="p-6">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 id="delete-detection-title" className="text-lg font-semibold text-gray-900">Delete Detection</h3>
